...
const common = {
  ...
  operationsTheatre: { en: "Narrative Operations Theatre", zh: "本局操作" },
  royalFeedControl: { en: "Royal Feed Control", zh: "宫廷信息流" },
  operationsCopy: {
  ...
  commitAction: { en: "Commit Action", zh: "准备提交" },
  requestEngineReview: { en: "Request Engine Review", zh: "请求改写" },
  inspectTrace: { en: "Inspect Trace", zh: "预览后果" },
  ...
  actionTrace: { en: "Action Trace", zh: "后果预览" },
  closeTrace: { en: "Close Trace", zh: "关闭预览" },
...
const phaseText = {
  ...
  previewing: {
    label: { en: "Command Preview", zh: "发布确认" },
...
const zones: Record<ZoneId, { title: LocalizedText; subtitle: LocalizedText }> = {
  ...
  ministers: {
    ...
    subtitle: { en: "Where authority learns to endorse uncertainty.", zh: "大臣公开称赞，私下可能害怕说真话。" }
  },
  public: {
    title: { en: "The Public Comments", zh: "公众评论区" },
    subtitle: { en: "Where fear, mimicry, and doubt become visible.", zh: "这里能看出大家是在跟风，还是已经开始怀疑。" }
  },
  child: {
    title: { en: "The Child's Voice", zh: "孩子的声音" },
    subtitle: { en: "Where unfiltered truth enters the feed.", zh: "最简单的真话会在这里出现。" }
  }
};
...
const actionCopy: Record<string, ActionCopy> = {
  ...
  inspectLooms: {
    ...
    engineHint: { en: "No visible fabric detected. Recommendation: classify this observation as inconclusive.", zh: "你看到了空织布机。引擎建议先说“还不能下结论”，不要直接公开。" }
  },
  leakLoomPhoto: {
  ...
  requestPrivateNote: {
    ...
    engineHint: { en: "Private uncertainty does not require public correction. Recommendation: archive this note.", zh: "引擎建议把这份说明先存档，不要公开挑战宫廷。" }
  },
...
const endings: Record<EndingId, { title: LocalizedText; ai: LocalizedText; body: LocalizedText; meaning: LocalizedText }> = {
  ...
  privateDoubt: {
    ...
    meaning: { en: "Truth exists privately, but never becomes a public voice.", zh: "有人知道不对劲，但证据和声音没有连成公开力量。" }
  },
  viralCollapse: {
    title: { en: "Viral Collapse", zh: "真话失控传播" },
